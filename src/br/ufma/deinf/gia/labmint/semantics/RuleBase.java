...
public class RuleBase extends ElementValidation{
    ...
    public RuleBase(NclValidatorDocument doc) {
		super(doc);
	}

	public boolean validate(Element eRuleBase){
        boolean resultado = true;

        //
        if(!hasValidRuleBaseIDAttribute(eRuleBase)) resultado = false;

        return resultado;
    }

    private boolean hasValidRuleBaseIDAttribute(Element eRuleBase){
        //TODO: All!
        return true;
    }
