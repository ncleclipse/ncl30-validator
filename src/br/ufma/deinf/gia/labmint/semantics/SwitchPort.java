...
public class SwitchPort extends ElementValidation{

    public SwitchPort(NclValidatorDocument doc) {
		super(doc);
	}

	public boolean validate(Element eSwitchPort){
        boolean resultado = true;

        //
        if(!hasValidSwitchPortIDAttribute(eSwitchPort)) resultado = false;

        return resultado;
    }

    private boolean hasValidSwitchPortIDAttribute(Element eSwitchPort){
        //TODO: All!
        return true;
    }
