...
public class ImportBase extends ElementValidation{
	...
	public boolean validate(Element eImportBase){
        ...
        //
        if(!hasValidImportBaseRegionAttribute(eImportBase)) resultado = false;

        //
        if(!hasValidImportBaseAliasAttribute(eImportBase)) resultado = false;

        //
        if(!hasValidImportBaseDocumentURIAttribute(eImportBase)) resultado = false;
