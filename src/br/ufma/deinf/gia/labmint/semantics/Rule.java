...
public class Rule extends ElementValidation{
	...
	public boolean validate(Element eRule){
        ...
        //
        if(!hasValidRuleValueAttribute(eRule)) resultado = false;

        //
        if(!hasValidRuleComparatorAttribute(eRule)) resultado = false;

        //
        if(!hasValidRuleVarAttribute(eRule)) resultado = false;
