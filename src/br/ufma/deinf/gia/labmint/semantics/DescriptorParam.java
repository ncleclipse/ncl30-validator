...
public class DescriptorParam extends ElementValidation{
    ...
    public DescriptorParam(NclValidatorDocument doc) {
		super(doc);
	}

	public boolean validate(Element eDescriptorParam){
        boolean resultado = true;

        //
        if(!hasValidDescriptorParamNameAttribute(eDescriptorParam)) resultado = false;

        //
        if(!hasValidDescriptorParamValueAttribute(eDescriptorParam)) resultado = false;

        return resultado;
    }

    private boolean hasValidDescriptorParamNameAttribute(Element eDescriptorParam){
        //TODO: All!
        return true;
    }

    private boolean hasValidDescriptorParamValueAttribute(Element eDescriptorParam){
        //TODO: All!
        return true;
    }
