...
public class Body extends ElementValidation{

    public Body(NclValidatorDocument doc){
        super(doc);
    }

    public boolean validate(Element eBody){
        boolean resultado = true;

        //
        if(!hasValidBodyIDAttribute(eBody)) resultado = false;

        return resultado;
    }

    private boolean hasValidBodyIDAttribute(Element eBody){
        //TODO: All!
        return true;
    }
