...
public class CompoundCondition extends ElementValidation {
	...
	public boolean validate(Element eCompoundCondition) {
		...
		//
		if (!hasValidCompoundConditionDelayAttribute(eCompoundCondition))
			resultado = false;

		//
		if (!hasValidCompoundConditionOperatorAttribute(eCompoundCondition))
			resultado = false;

		return resultado;
	}

	private boolean hasValidCompoundConditionDelayAttribute(
			Element eCompoundCondition) {
		//TODO: All!
		return true;
	}

	private boolean hasValidCompoundConditionOperatorAttribute(
			Element eCompoundCondition) {
		//TODO: All!
		return true;
	}
