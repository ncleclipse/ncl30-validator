...
public class DescriptorSwitch extends ElementValidation{

    public DescriptorSwitch(NclValidatorDocument doc) {
		super(doc);
	}

	public boolean validate(Element eDescriptorSwitch){
        boolean resultado = true;

        //
        if(!hasValidDescriptorSwitchAttribute(eDescriptorSwitch)) resultado = false;

        return resultado;
    }

    private boolean hasValidDescriptorSwitchAttribute(Element eDescriptorSwitch){
        //TODO: All!
        return true;
    }
