...
public class CompoundAction extends ElementValidation{

    public CompoundAction(NclValidatorDocument doc){
        super(doc);
    }

    public boolean validate(Element eCompoundAction){
        boolean resultado = true;

        //
        if(!hasValidCompoundActionDelayAttribute(eCompoundAction)) resultado = false;

        //
        if(!hasValidCompoundActionOperatorAttribute(eCompoundAction)) resultado = false;

        return resultado;
    }

    private boolean hasValidCompoundActionDelayAttribute(Element eCompoundAction){
        //TODO: All!
        return true;
    }

    private boolean hasValidCompoundActionOperatorAttribute(Element eCompoundAction){
        //TODO: All!
        return true;
    }
