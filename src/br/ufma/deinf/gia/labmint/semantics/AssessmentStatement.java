...
public class AssessmentStatement extends ElementValidation {
	...
	public boolean validate(Element eAssessmentStatement) {
		...
		//
		if (!hasValidAssessmentStatementComparatorAttribute(eAssessmentStatement))
			resultado = false;

		return resultado;
	}

	private boolean hasValidAssessmentStatementComparatorAttribute(
			Element eAssessmentStatement) {
		//TODO: All!
		return true;
	}
