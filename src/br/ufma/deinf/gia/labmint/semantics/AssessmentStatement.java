...
public class AssessmentStatement extends ElementValidation{

    public AssessmentStatement(NclValidatorDocument doc){
        super(doc);
    }

    public boolean validate(Element eAssessmentStatement){
        boolean resultado = true;

        //
        if(!hasValidAssessmentStatementComparatorAttribute(eAssessmentStatement)) resultado = false;

        return resultado;
    }

    private boolean hasValidAssessmentStatementComparatorAttribute(Element eAssessmentStatement){
        //TODO: All!
        return true;
    }
