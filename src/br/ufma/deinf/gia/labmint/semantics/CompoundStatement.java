...
public class CompoundStatement extends ElementValidation {
	...
	public boolean validate(Element eCompoundStatement) {
		...
		//
		if (!hasValidCompoundStatementIsNegatedAttribute(eCompoundStatement))
			resultado = false;

		//
		if (!hasValidCompoundStatementOperatorAttribute(eCompoundStatement))
			resultado = false;

		return resultado;
	}

	private boolean hasValidCompoundStatementIsNegatedAttribute(
			Element eCompoundStatement) {
		//TODO: All!
		return true;
	}

	private boolean hasValidCompoundStatementOperatorAttribute(
			Element eCompoundStatement) {
		//TODO: All!
		return true;
	}
