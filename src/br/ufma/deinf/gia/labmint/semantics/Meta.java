...
public class Meta extends ElementValidation{


    public Meta(NclValidatorDocument doc) {
		super(doc);
	}

	public boolean validate(Element eMeta){
        boolean resultado = true;

        //
        if(!hasValidMetaNameAttribute(eMeta)) resultado = false;

        //
        if(!hasValidMetaContentAttribute(eMeta)) resultado = false;

        return resultado;
    }

    private boolean hasValidMetaNameAttribute(Element eMeta){
        //TODO: All!
        return true;
    }

    private boolean hasValidMetaContentAttribute(Element eMeta){
        //TODO: All!
        return true;
    }
