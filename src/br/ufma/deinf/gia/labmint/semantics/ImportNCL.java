...
public class ImportNCL extends ElementValidation{

    public ImportNCL(NclValidatorDocument doc) {
		super(doc);
	}

	public boolean validate(Element eImportNCL){
        boolean resultado = true;

        //
        if(!hasValidImportNCLDocumentURIAttribute(eImportNCL)) resultado = false;

        return resultado;
    }

    private boolean hasValidImportNCLDocumentURIAttribute(Element eImportNCL){
        //TODO: All!
        return true;
    }
